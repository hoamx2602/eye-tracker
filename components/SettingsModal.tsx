              ...
              <>
                 ...
                 <div className="bg-gray-800 p-3 rounded-lg space-y-4 border border-gray-700">
                     ...
                     <div>
                        ...
                        <input type="range" min="30" max="60" step="5" value={localConfig.faceDistance} onChange={(e) => handleChange('faceDistance', parseInt(e.target.value))} className="w-full accent-gray-500 h-1 bg-gray-600 rounded-lg appearance-none cursor-pointer"/>
                     </div>
                     <div>
