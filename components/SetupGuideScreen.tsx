          ...
          <div className="px-6 pb-6 flex justify-between items-center gap-3">
            ...
            <button
              ...
              className={[
                ...
                // A dim tint of the same blue still reads as "on" at a glance —
                // this is what a participant unable to proceed past Camera
                // Access without granting it saw as a lit-up Continue. Flat grey
                // makes "not yet" visually unambiguous.
                canProceed
